...
public class Juego3 extends javax.swing.JFrame {
    ...
    private LogicaJuego3 log = new LogicaJuego3();
    ...
    private void setCartas() {
        ...
        jButton1.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[0] + ".png")));
        jButton2.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[1] + ".png")));
        jButton3.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[2] + ".png")));
        jButton4.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[3] + ".png")));
        jButton5.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[4] + ".png")));
        jButton6.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[5] + ".png")));
       jButton7.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[6] + ".png")));
        jButton8.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[7] + ".png")));
        jButton9.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[8] + ".png")));
        jButton10.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[9] + ".png")));
       jButton11.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[10] + ".png")));
        jButton12.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[11] + ".png")));
        jButton13.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[12] + ".png")));
        jButton14.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[13] + ".png")));
        jButton15.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[14] + ".png")));
        jButton16.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[15] + ".png")));
        jButton17.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[16] + ".png")));
        jButton18.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[17] + ".png")));
        jButton19.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[18] + ".png")));
        jButton20.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[19] + ".png")));
        jButton21.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[20] + ".png")));
        jButton22.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[21] + ".png")));
        jButton23.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[22] + ".png")));
        jButton24.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[23] + ".png")));
        jButton25.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[24] + ".png")));
        jButton26.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[25] + ".png")));
        jButton27.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[26] + ".png")));
        jButton28.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[27] + ".png")));
        jButton29.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[28] + ".png")));
        jButton30.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + numbers[29] + ".png")));
 ...
 private void btnEnabled(JButton btn) {
    ...
    private void pregwin() {
        if (!jButton1.isEnabled() && !jButton2.isEnabled() && !jButton3.isEnabled() && !jButton4.isEnabled() && !jButton5.isEnabled() && !jButton6.isEnabled()
                ...
                && !jButton12.isEnabled()&& !jButton13.isEnabled()&& !jButton14.isEnabled()&& !jButton15.isEnabled()&& !jButton16.isEnabled()&& !jButton17.isEnabled()
                && !jButton18.isEnabled()&& !jButton19.isEnabled()&& !jButton20.isEnabled()&& !jButton21.isEnabled()&& !jButton22.isEnabled()&& !jButton23.isEnabled()
                && !jButton24.isEnabled()&& !jButton25.isEnabled()&& !jButton26.isEnabled()&& !jButton27.isEnabled()&& !jButton28.isEnabled()&& !jButton29.isEnabled()&& !jButton30.isEnabled()) {
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/c0.png"))); // NOI18N
        ...
        jLabel1.setText("Nivel Dificil");

        jButton31.setText("reiniciar");
